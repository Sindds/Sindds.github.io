...
const Footer = ({ 
  ...
  socialLinks = [
    { 
      ...
      icon: <img src='/public/HHru_icon.png' alt='HH.ru' className='w-10 h-10 hover:scale-110'></img>
    },
    { 
      name: "", 
      href: "https://t.me/sdmitris", 
      icon: <img src='/public/telegram_icon.png' alt='Telegram' className='w-10 h-10 hover:scale-110'></img>
    },
    { 
      name: "", 
      href: "#", 
      icon: <img src='/public/GitHub_icon.png' alt='GitHub' className='w-14 h-14 hover:scale-110'></img>
    }
  ]
}) => {
