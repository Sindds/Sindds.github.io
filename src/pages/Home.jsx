...
const HeroSection = () => {
  const technologies = [
    { name: 'HTML5', icon: '/public/HTML5_icon.png' },
    { name: 'CSS3', icon: '/public/CSS3_icon.png' },
    { name: 'JavaScript', icon: '/public/JavaScript_icon.png' },
    { name: 'React', icon: '/public/React_icon.png' },
    { name: 'Git', icon: '/public/Git_icon.png' },
  ];
    ...
    <section className="min-h-screen flex flex-col justify-center items-center relative px-4 py-12">
      <div className="text-center max-w-4xl mx-auto mb-16">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">
          Привет! Я <span className="text-blue-600">Синдяев Дмитрий</span>,<br /> начинающий фронтенд-разработчик.
        </h1>
        
        <p className="text-xl text-gray-600 mb-8 leading-relaxed">
          Мой React — это не только <code className="bg-gray-100 px-2 py-1 rounded">useState</code> и <code className="bg-gray-100 px-2 py-1 rounded">useEffect</code>, 
          но и искренний интерес к тому, как кусочки кода складываются в удобные и живые интерфейсы. 
          Учусь каждый день, чтобы создавать то, что по-настоящему нравится людям.
        </p>
        
        <div className="flex justify-center gap-4">
          <a href='/portfolio' className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-all duration-300 transform hover:-translate-y-1">
            Мои проекты
          </a>
          <a href='/contacts' className="border border-gray-300 hover:border-blue-600 text-gray-700 hover:text-blue-600 px-6 py-3 rounded-lg transition-all duration-300 transform hover:-translate-y-1">
            Написать мне
          </a>
        </div>
      </div>
