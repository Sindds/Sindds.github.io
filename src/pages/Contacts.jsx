...
const Contacts = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.sendForm(
      'service_83mymxb',       // Service ID
      'template_sp3rzpq',      // Template ID
      formRef.current,
      'iOEPFGFwq6sofoU_x'           // Public ID
    ).then(() => {
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex items-center justify-center sm:justify-start">
              ...
              <a href="https://t.me/sdmitris" className="text-blue-600 hover:underline" target="_blank" rel="noreferrer">Telegram</a>
            </div>
            <div className="flex items-center justify-center sm:justify-start">
              <svg className="w-5 h-5 mr-3 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8l8 5 8-5v10zm-8-7L4 6h16l-8 5z"/>
              </svg>
              <a className="text-blue-600 hover:underline">sindyaewds@yandex.ru</a>
            </div>
            <div className="flex items-center justify-center sm:justify-start">
              <svg className="w-5 h-5 mr-3 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center justify-center sm:justify-start">
              ...
              <a href="https://github.com/Sindds/Sindds.github.io" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">GitHub</a>
            </div>
          </div>
        </div>
      </div>
